...
#work
# import datafile
Smallset = read.csv("social_conflict_in_ccs_v5_Attitude_influence_experiment_table.csv", header = TRUE, sep = ",", skip = 6, check.names = FALSE)
...
Endpoinmelt <- melt(Endpoint, measure.vars=c("0to20",
                                               "20to40",
                                               "40to60",
                                               "60to80",
...
ggplot(Smallset) + 
  stat_smooth(aes(x=tick,y=mean_attitude_of_citizens,group=Citizen_influence_others_attitude,colour=Citizen_influence_others_attitude)) + 
...
ggplot(Smallset) + 
  stat_smooth(aes(x=tick,y=median_attitude_of_citizens,group=Citizen_influence_others_attitude,colour=Citizen_influence_others_attitude)) + 
  facet_grid(Difference_in_vba_value1 + Difference_in_vba_value2~Difference_in_vba_value3,labeller=label_both)

ggplot(Smallset) + 
  stat_smooth(aes(x=tick,y=average_euclidean_distance_average_citizens_vs_project_leaders,group=Citizen_influence_others_attitude,colour=Citizen_influence_others_attitude)) + 
  facet_grid(Start_accept + Xaccept ~Start_reject + Xreject + Relative_power_counter_vba,labeller=label_both)
...
ggplot(aes(x = Attitude_scales, y = Number_of_citizens_attitude), data = Endpointmelt) + 
  stat_summary(fun.y = "mean", geom = "bar", position = "dodge") + facet_grid(Difference_in_vba_value1 + 
    Difference_in_vba_value2 + Difference_in_vba_value3~Citizen_influence_others_attitude,labeller=label_both)
